...
import { ArrowRight, Package, DollarSign, TrendingUp } from 'lucide-react';
...
function Dashboard() {
  const { data: activeProducts, isLoading: loadingActive } = trpc.products.getAll.useQuery({
    filter_by: 'active',
    per_page: 100,
  });
  ...
  const totalValue = allProducts?.products.reduce(
    (sum, product) => sum + (product.status === ProductStatus.ACTIVE ? product.price_cents : 0),
    0
  ) || 0;
        ...
        <Grid>
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="sm" c="dimmed">All products in system</Text>
            </Card>
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="sm" c="dimmed">{inactiveCount} inactive</Text>
            </Card>
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="xl" fw={700}>{PriceUtils.formatPrice(totalValue)}</Text>
              <Text size="sm" c="dimmed">Active products only</Text>
            </Card>
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="xl" fw={700}>{PriceUtils.formatPrice(avgPrice)}</Text>
              <Text size="sm" c="dimmed">Per active product</Text>
            </Card>
          </Grid.Col>
        </Grid>
            ...
            <Link to="/products">
              <Group justify="space-between" style={{ cursor: 'pointer' }}>
                <div>
                  ...
                  <Text size="sm" c="dimmed">Browse and manage your product inventory</Text>
                </div>
                <ArrowRight size={20} />
              </Group>
            </Link>
            ...
            <Link to="/products/create">
              <Group justify="space-between" style={{ cursor: 'pointer' }}>
                <div>
                  ...
                  <Text size="sm" c="dimmed">Create a new product entry</Text>
                </div>
                <ArrowRight size={20} />
              </Group>
            </Link>
